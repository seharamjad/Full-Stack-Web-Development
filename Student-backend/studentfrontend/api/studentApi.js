...
export const addStudent = async(data) => (await api.post('/api/students/add')).data
//function to update student API
export const updateStudent = async(id,data) => (await api.put(`/api/students/update/${id}`)).data
